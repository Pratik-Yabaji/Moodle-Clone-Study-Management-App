...
<body>
    ...
    <div class="row center mx-5 mb-5 shadow-lg p-3">
        ...
        <form class="col-md-6 d-flex flex-column my-4" action="./welcome.php" method="post">
            <h1 class="features">Log in</h1>
            <div class="mb-3">
            ...
            <h6 class="text-muted mt-3">Don't have an account ? <a href="./signup.html" class="features">Sign Up</a></h6>
        </form>
    </div>
</body>
</html>